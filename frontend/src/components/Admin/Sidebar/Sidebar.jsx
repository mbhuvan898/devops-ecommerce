...
const Sidebar = ({ activeTab, setToggleSidebar }) => {
    ...
    return (
        <>
            ...
            <aside className={`sidebar fixed left-0 top-0 h-screen w-72 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white overflow-y-auto border-r border-gray-700 shadow-2xl transition-transform duration-300 ${setToggleSidebar ? 'z-50 translate-x-0' : 'z-10 sm:translate-x-0 -translate-x-full sm:block'}`}>
                ...
                <div className="flex items-center gap-3 bg-gradient-to-r from-blue-600 to-purple-600 p-4 rounded-xl shadow-lg my-4 mx-3.5">
                    ...
                    <div className="flex flex-col gap-0 flex-1 min-w-0">
                        ...
                        <span className="text-blue-100 text-xs truncate">{user.email}</span>
                    </div>
                    {setToggleSidebar && (
                        <button 
                            onClick={() => setToggleSidebar(false)} 
                            className="sm:hidden bg-white/20 backdrop-blur-sm rounded-full w-9 h-9 flex items-center justify-center hover:bg-white/30 transition-all flex-shrink-0"
                        >
                ...
                <div className="flex flex-col gap-2 bg-gradient-to-br from-gray-800 to-gray-900 p-4 rounded-xl shadow-lg mb-6 mt-auto mx-3.5 overflow-hidden border border-gray-700">
                    ...
                    <div className="flex flex-col gap-0">
                        <a 
                            ...
                            target="_blank" 
                            rel="noreferrer" 
                            className="font-semibold text-base hover:text-blue-400 transition-colors truncate"
                        >
                            mbhuvan
                        </a>
                        <a 
                            href="mailto:jigarsable21@gmail.com" 
                            className="text-gray-400 text-xs hover:text-blue-400 transition-colors truncate"
                        >
                            mbhuvn898@gmail.com
                        </a>
                    </div>
