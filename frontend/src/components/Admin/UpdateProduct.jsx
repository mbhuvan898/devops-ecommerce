...
const UpdateProduct = () => {
    ...
    return (
        <>
            <MetaData title="Admin: Update Product | Best2Buy" />

            {loading && <BackdropLoader />}
            {updateLoading && <BackdropLoader />}
            <form onSubmit={updateProductSubmitHandler} className="flex flex-col sm:flex-row bg-white rounded-lg shadow p-4" id="mainform">
