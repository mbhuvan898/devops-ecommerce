  ...
  <div className="absolute bottom-0 left-0 right-0">
    <svg className="w-full h-24 sm:h-32" viewBox="0 0 1440 120" fill="none" preserveAspectRatio="none">
      ...
      />
        ...
        {/* CTA BANNER - Changed to Purple/Indigo Gradient */}
        <section className="relative py-20 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 overflow-hidden">
          <div className="absolute inset-0">
            ...
            <div className="absolute top-0 right-0 w-96 h-96 bg-pink-400 rounded-full filter blur-3xl opacity-20 animate-blob"></div>
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-indigo-700 rounded-full filter blur-3xl opacity-25 animate-blob animation-delay-2000"></div>
          </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            ...
            <p className="text-xl sm:text-2xl text-purple-100 mb-10 max-w-2xl mx-auto font-light leading-relaxed">
              Sign up today and receive an exclusive discount on your first purchase. Limited time only!
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/register">
                <button className="group px-10 py-5 bg-white text-indigo-600 font-black rounded-xl hover:bg-purple-50 transition-all shadow-2xl hover:shadow-3xl hover:scale-105 text-lg flex items-center gap-3">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-8 text-sm">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-yellow-400 rounded-full flex items-center justify-center shadow-lg">
                  <span className="text-indigo-800 font-bold text-xs">✓</span>
                </div>
