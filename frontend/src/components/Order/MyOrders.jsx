...
const MyOrders = () => {
    ...
    return (
        <>
            <MetaData title="My Orders | Best2Buy" />
                    ...
                    <div className="hidden sm:flex flex-col w-1/5 px-1">
                        ...
                        <div className="flex flex-col bg-white rounded-sm shadow">
                            ...
                            <div className="flex items-center justify-between gap-5 px-4 py-2 border-b">
                                ...
                                <span onClick={clearFilters} className="text-primary-accent font-medium text-sm uppercase cursor-pointer hover:text-green-700">clear all</span>
                            </div>
                        ...
                        {loading ? <Loader /> : (
                            <div className="flex flex-col gap-3 sm:mr-4 overflow-hidden">
                                ...
                                <form onSubmit={searchOrders} className="flex items-center justify-between mx-1 sm:mx-0 sm:w-10/12 bg-white border rounded hover:shadow">
                                    ...
                                    <button type="submit" className="h-full text-sm px-1 sm:px-4 py-2.5 text-white bg-primary-accent hover:bg-green-600 rounded-r flex items-center gap-1">
