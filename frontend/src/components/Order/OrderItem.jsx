// C:\Users\BHUVAN M\Downloads\newone\project\frontend\src\components\Order\OrderItem.jsx
...
const OrderItem = (props) => {
    ...
    return (
        <Link to={`/order/${orderId}`} className="flex p-4 items-start bg-white border rounded gap-2 sm:gap-0 hover:shadow-lg">
            {/* <!-- image container --> */}
